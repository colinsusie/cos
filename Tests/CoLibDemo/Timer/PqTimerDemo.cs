...
public class TimerGroup : ITimerGroup
{
}

public static class PqTimerDemo
{
    ...
    public static void Start()
    {
        ...
        _logger = logMgr.GetLogger("PqTimerDemo");
        _scheduler = TimerFactory.CreatePqTimerScheduler(logMgr.GetLogger("PqTimerScheduler"));
